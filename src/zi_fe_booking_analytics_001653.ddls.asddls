...
define root view entity zi_fe_booking_analytics_001653
  as select from zfe_abook_001653 as Booking
  association [0..1] to zi_fe_travel_analytics_001653 as _Travel on $projection.TravelUUID = _Travel.TravelUUID
