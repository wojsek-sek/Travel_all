...
define view entity zi_fe_conn_001653
  as select from zfe_aconn_001653 as Connection
  association [1..1] to zi_fe_carr_001653 as _Airline on $projection.AirlineID = _Airline.AirlineID
{
